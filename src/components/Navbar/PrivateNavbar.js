...
import { logoutAction } from "../../redux/slices/users/usersSlicess";
            ...
            <div className="flex h-16 justify-between">
              <div className="flex">
                ...
                <div className="hidden md:ml-6 md:flex md:space-x-8">
                  {/* Current: "bordexr-indigo-500 text-gray-900", Default: "border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700" */}
                  <Link
                    to={"/"}
