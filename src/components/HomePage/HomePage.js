...
import PublicContents from "../Content/PublicContents";
          ...
          <div className="container px-4 mx-auto">
            <div className="flex flex-wrap items-center">
              <div className="w-full lg:w-1/2 mb-20 lg:mb-0">
                ...
                Evallo - Empower Your Tutoring Business
                </h1>
                <p className="mb-8 text-lg md:text-xl leading-7 text-coolGray-500 font-medium">
                  Simplify Operations, Maximize Impact
                </p>
                <ul>
                  <li className="mb-6 flex items-center">
                 
                    <p className="text-lg md:text-xl leading-7 text-coolGray-500 font-medium">
                    Evallo brings a seamless integration of CRM, Calendar, Invoicing, and Assignment management to tutoring businesses. With our upcoming content marketplace, access a vast library of academic materials directly tailored for your students' success.
                    </p>
                  </li>
                  <li className="mb-6 flex items-center">
                   
                    <p className="text-lg md:text-xl leading-7 text-coolGray-500 font-medium">
                      For Tutoring Companies & Independent Tutors
                    </p>
                  </li>
                  <li className="flex items-center">
                  
                    <p className="text-lg md:text-xl leading-7 text-coolGray-500 font-medium">
                      For Academic Content Writers
                    </p>
                  </li>
                </ul>
              </div>
